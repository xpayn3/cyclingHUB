...
import { renderRouteBuilderPage, rbUndo, rbRedo, rbReverse, rbOutAndBack,
         rbLoopBack, rbClear, rbSave, rbLoadRoute, rbDeleteSavedRoute,
         ...
         _rbToggleCyclOSM, _rbToggleTerrain, _rbConfirmLeave } from './js/routes.js';

import { renderHeatmapPage, hmLoadAllRoutes, hmApplyFilters, hmRedraw,
         hmToggleAnimate, _hmOpenDB } from './js/heatmap.js';

import { wrkRender, wrkRefreshStats, wrkAddSegment, wrkRemove, wrkMove,
         ...
         loadSmoothFlyover, toggleSmoothFlyover, toggleTerrain3d } from './js/workout.js';
...
Object.assign(window, { state, ICU_BASE, STRAVA_API_BASE, STRAVA_AUTH_BASE,
  STRAVA_AUTH_URL, STORAGE_LIMIT, safeMax, safeMin, _rIC, GREETINGS });
...
Object.assign(window, { renderRouteBuilderPage, rbUndo, rbRedo, rbReverse,
  rbOutAndBack, rbLoopBack, rbClear, rbSave, rbLoadRoute, rbDeleteSavedRoute,
...
Object.assign(window, { renderHeatmapPage, hmLoadAllRoutes, hmApplyFilters,
  hmRedraw, hmToggleAnimate });

// ── From workout.js (includes settings/theme functions) ──
Object.assign(window, { wrkRender, wrkAddSegment, wrkRemove, wrkMove,
...
Object.assign(window, {
  ...
  setActivitiesSort, setActivitiesSport, setActivitiesYear,
  stepActivity, streamsZoomIn, streamsZoomOut, streamsResetZoom,
  toggleMapFullscreen, toggleMapStats,
  ...
  updateStorageBar, setUnits, copySetupLink, handleAvatarUpload, removeAvatar,
  ...
  _mlGetStyle, _mlApplyTerrain, _addCyclOSMLayer, _addRoadSafetyLayer,
